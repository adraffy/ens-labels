...
<!-- summary -->
`3,380,123` unique, stop-free labels as of `2025-10-26` collected from ENS contract events and primary name records.

* [`48.6MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`72ba28d41d8e2149427561cfadf0908f906f4c64b8746464bfef72264cb257f9` (SHA256)
<!-- /summary -->
