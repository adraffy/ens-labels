...
<!-- summary -->
`3,388,356` unique, stop-free labels as of `2025-12-07` collected from ENS contract events and primary name records.

* [`48.7MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`cc518a4cd88807a8854551db15eb06287ef2d07a9abd5c7e9240fe2e03028a94` (SHA256)
<!-- /summary -->
