...
<!-- summary -->
`3,372,190` unique, stop-free labels as of `2025-09-20` collected from ENS contract events and primary name records.

* [`48.5MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`eeacb7d93f38d49591bebea693c076bdeb4543952ecaa3c049a6e256f6dca79a` (SHA256)
<!-- /summary -->
