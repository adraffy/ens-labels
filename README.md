...
<!-- summary -->
`3,356,216` unique, stop-free labels as of `2025-08-03` collected from ENS contract events and primary name records.

* [`48.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`9e8fd348c4bbd9e23f758734bbf9ed5c016a406b87141621f3b4ade336747bdc` (SHA256)
<!-- /summary -->
