...
<!-- summary -->
`3,416,711` unique, stop-free labels as of `2026-07-29` collected from ENS contract events and primary name records.

* [`49.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`cf0e67e984d77c76e57b46a085eaf0ddf0b54912930eb3aba32cf065c1c96cdd` (SHA256)
<!-- /summary -->
