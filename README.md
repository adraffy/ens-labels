...
<!-- summary -->
`3,414,155` unique, stop-free labels as of `2026-06-21` collected from ENS contract events and primary name records.

* [`49.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`3fa95d81be400be13f2457ca4dbfdc955758faedbfed646bad9720d1d5c07bab` (SHA256)
<!-- /summary -->
