...
<!-- summary -->
`3,270,505` unique, stop-free labels as of `2024-09-16` collected from ENS contract events and primary name records.

* [`47.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`d403d43d4d5389f2c82bec63a85326dd9df73db00b7caab22419760bcb8dd040` (SHA256)
<!-- /summary -->
