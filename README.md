...
<!-- summary -->
`2,903,687` unique, stop-free labels as of `2024-05-25` collected from ENS contract events and primary name records.

* [`41.9MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`33e5987b78354c82d2e337492d2b02e8bc37cc0f9d69afbddf262e99d094521a` (SHA256)
<!-- /summary -->
