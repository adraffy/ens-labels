...
<!-- summary -->
`2,852,405` unique, stop-free labels as of `2024-04-07` collected from ENS contract events and primary name records.

* [`41.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`fb88cf8e6098d85a8cfea829d7a3cea21f36202056f414192287952df8456911` (SHA256)
<!-- /summary -->
