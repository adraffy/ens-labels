...
<!-- summary -->
`2,927,176` unique, stop-free labels as of `2024-07-22` collected from ENS contract events and primary name records.

* [`42.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`a9c7efde506274a274f87ad4e5720d705a756a9b54e1fdfb8ffa97793cb15e37` (SHA256)
<!-- /summary -->
