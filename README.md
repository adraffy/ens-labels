...
<!-- summary -->
`2,749,081` unique, stop-free labels as of `2023-12-05` collected from ENS contract events and primary name records. 
 * [`39.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`80f99b0052ecc3cc54a1bb762bfa1febc5786bcb4188e8d6dd56cbd0f0a18bcf` (SHA256)
<!-- /summary -->
