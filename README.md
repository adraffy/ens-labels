...
<!-- summary -->
`2,565,746` unique, stop-free labels as of `2023-05-09` collected from ENS contract events and primary name records. 
 * [`37.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`e4ba644e64448504943dae3dfc6d59a50a2786190202b9a0e617727c0d755876` (SHA256)
<!-- /summary -->
