...
<!-- summary -->
`2,900,177` unique, stop-free labels as of `2024-05-18` collected from ENS contract events and primary name records.

* [`41.9MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`be553e7fee7ceef24d964cb3d7622b0c98d72948143107dfa03173bb532603d6` (SHA256)
<!-- /summary -->
