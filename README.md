...
<!-- summary -->
`2,741,054` unique, stop-free labels as of `2023-11-18` collected from ENS contract events and primary name records. 
 * [`39.7MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`6b81bbb3ec8d47ab6c6388f21e2ae78bafdf807e5c1684590cc0fc02b1b8ee62` (SHA256)
<!-- /summary -->
