...
<!-- summary -->
`3,419,192` unique, stop-free labels as of `2026-09-06` collected from ENS contract events and primary name records.

* [`49.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`9ed1d7adcb242080b00adcb7b1f7eda270a3f6b69fac97a7e89d38fa17bb9faa` (SHA256)
<!-- /summary -->
