...
<!-- summary -->
`3,399,555` unique, stop-free labels as of `2026-02-15` collected from ENS contract events and primary name records.

* [`48.9MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`c5bc1703192f2811d33681252be9dd0cacedf1332b3f491ae57256f1b167d6d0` (SHA256)
<!-- /summary -->
