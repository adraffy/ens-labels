...
<!-- summary -->
`2,925,963` unique, stop-free labels as of `2024-07-17` collected from ENS contract events and primary name records.

* [`42.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`2d632c35a5d73752f7ead02ef026a952eca1a076aa02617cf31a499971cb2d6d` (SHA256)
<!-- /summary -->
