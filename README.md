...
<!-- summary -->
`2,610,778` unique, stop-free labels as of `2023-07-01` collected from ENS contract events and primary name records. 
 * [`37.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`80b2233260cddca6dda3e6f33dc40ce4eef85dc57cbf0eea141a5fee48b90f90` (SHA256)
<!-- /summary -->
