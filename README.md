...
<!-- summary -->
`2,797,833` unique, stop-free labels as of `2024-02-03` collected from ENS contract events and primary name records. 
 * [`40.5MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`decaabdfd9d0a0a70167e61187c74efcd05bccd9e08d16337a7b06910a8fc0ed` (SHA256)
<!-- /summary -->
