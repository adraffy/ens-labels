...
<!-- summary -->
`2,539,350` unique, stop-free labels as of `2023-03-31` collected from ENS contract events and primary name records. 
 * [`36.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`f4bb52280ca0632e1ab4ab3cae225cb64c707541444189103b23188729e8cc39` (SHA256)
<!-- /summary -->
