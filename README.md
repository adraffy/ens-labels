...
<!-- summary -->
`3,333,090` unique, stop-free labels as of `2025-05-04` collected from ENS contract events and primary name records.

* [`47.9MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`b7869be1f54384ad23758ef6668516caafec067d2fbadd4cb37e1f6a8b644495` (SHA256)
<!-- /summary -->
