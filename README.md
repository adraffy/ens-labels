...
<!-- summary -->
`3,378,868` unique, stop-free labels as of `2025-10-20` collected from ENS contract events and primary name records.

* [`48.6MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`e8e8e799a7ed825bd4dd97c9fd44f77c817f9224c68e9dc71edf23839d0b8e28` (SHA256)
<!-- /summary -->
