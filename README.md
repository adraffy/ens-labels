...
<!-- summary -->
`2,653,244` unique, stop-free labels as of `2023-08-19` collected from ENS contract events and primary name records. 
 * [`38.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`f2d6246197ba267bbfc3572a4ced9f4798029cb839561c478a37a804a750048f` (SHA256)
<!-- /summary -->
