...
<!-- summary -->
`2,834,829` unique, stop-free labels as of `2024-03-20` collected from ENS contract events and primary name records.

* [`41.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`bcc69d7d51f27541369b74460f912e15dc6c8164e267246f229b5c45530230c6` (SHA256)
<!-- /summary -->
