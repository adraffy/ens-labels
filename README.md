...
<!-- summary -->
`2,622,359` unique, stop-free labels as of `2023-07-16` collected from ENS contract events and primary name records. 
 * [`38.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`367efce2f51640125fa1bf86b27ee84e7ff25eaa408710de6eb811a3a49f2a1c` (SHA256)
<!-- /summary -->
