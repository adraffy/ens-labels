...
<!-- summary -->
`2,641,266` unique, stop-free labels as of `2023-08-05` collected from ENS contract events and primary name records. 
 * [`38.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`cc6d04e6ed27216d17d7063319a069118f8eba172e55bae21eb1fe33e1372804` (SHA256)
<!-- /summary -->
