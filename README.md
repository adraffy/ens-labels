...
<!-- summary -->
`3,331,269` unique, stop-free labels as of `2025-04-26` collected from ENS contract events and primary name records.

* [`47.9MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`76cbe50d01b845cd77ea59043956488a835729280bc10465558cc85f77280c15` (SHA256)
<!-- /summary -->
