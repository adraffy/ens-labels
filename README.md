...
<!-- summary -->
`3,281,838` unique, stop-free labels as of `2024-11-03` collected from ENS contract events and primary name records.

* [`47.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`09c346a444587d8df768c72530508b0a84468509895310cf278ee596779837a1` (SHA256)
<!-- /summary -->
