...
<!-- summary -->
`3,390,166` unique, stop-free labels as of `2025-12-22` collected from ENS contract events and primary name records.

* [`48.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`69026f76abfbe047e96d77e70295cf6663f0642ea7833785e41488f605577b9a` (SHA256)
<!-- /summary -->
