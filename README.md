...
<!-- summary -->
`3,404,221` unique, stop-free labels as of `2026-03-10` collected from ENS contract events and primary name records.

* [`49.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`b5e3b74a0a3836538f39231e3242ae986fecf6e55d6a33095d94f7f0f96b1fd9` (SHA256)
<!-- /summary -->
