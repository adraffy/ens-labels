...
<!-- summary -->
`3,418,720` unique, stop-free labels as of `2026-08-30` collected from ENS contract events and primary name records.

* [`49.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`51089fa16cf138adb4ae31006d2b0cf21b713392aae1cf88d46e60ed37c31c9c` (SHA256)
<!-- /summary -->
