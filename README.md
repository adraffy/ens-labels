...
<!-- summary -->
`2,524,072` unique, stop-free labels as of `2023-03-21` collected from ENS contract events and primary name records. 
 * [`36.6MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`d6ae7c077a46bd7eb0c9a23033e8f56cb75343d6c505b4c9b8620910bf5d8741` (SHA256)
<!-- /summary -->
