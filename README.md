...
<!-- summary -->
`3,391,009` unique, stop-free labels as of `2025-12-29` collected from ENS contract events and primary name records.

* [`48.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`e2a0271c447520036a943bea9305006fc9075c0753b5b8865fbe7c19a46a8ab1` (SHA256)
<!-- /summary -->
