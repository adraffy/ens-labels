...
<!-- summary -->
`3,367,191` unique, stop-free labels as of `2025-08-30` collected from ENS contract events and primary name records.

* [`48.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`2db48c3446c9a34e8d4c6d5d9bf01081682259d1f2e6736d22f57e7e687dc4cc` (SHA256)
<!-- /summary -->
