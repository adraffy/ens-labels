...
<!-- summary -->
`3,292,074` unique, stop-free labels as of `2024-12-24` collected from ENS contract events and primary name records.

* [`47.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`3a0975d4c5da508f1a81d66190b5784fcfcbde2f9be13a8325ebaca02c832996` (SHA256)
<!-- /summary -->
