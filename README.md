...
<!-- summary -->
`2,919,224` unique, stop-free labels as of `2024-06-30` collected from ENS contract events and primary name records.

* [`42.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`7aa2bc3eadedc894462af4f14d0d85a2ef6e13b48cff3689826f4fb9df7f7ef0` (SHA256)
<!-- /summary -->
