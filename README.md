...
<!-- summary -->
`2,559,264` unique, stop-free labels as of `2023-04-22` collected from ENS contract events and primary name records. 
 * [`37.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`01077ac87675c8a426fc099a1fbc422f24dc5b3e10cb8ab7ba6d1a546667a287` (SHA256)
<!-- /summary -->
