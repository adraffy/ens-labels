...
<!-- summary -->
`2,779,752` unique, stop-free labels as of `2024-01-20` collected from ENS contract events and primary name records. 
 * [`40.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`d902bc3f6cb94c07efbde525dd0a31ec7dd65330299123e25ec4d677ccc9b046` (SHA256)
<!-- /summary -->
