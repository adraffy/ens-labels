...
<!-- summary -->
`3,323,928` unique, stop-free labels as of `2025-03-16` collected from ENS contract events and primary name records.

* [`47.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`ecc70d89a2c30fe2228ebe6d8e80db7a410f6269647c417251e7864065cab3c6` (SHA256)
<!-- /summary -->
