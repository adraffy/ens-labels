...
<!-- summary -->
`3,307,058` unique, stop-free labels as of `2025-02-01` collected from ENS contract events and primary name records.

* [`47.5MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`8b71528bf611a4c40853f87cd280c2e0167ca9777b54a15e3a83629d026b7048` (SHA256)
<!-- /summary -->
