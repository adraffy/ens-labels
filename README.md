...
<!-- summary -->
`2,672,769` unique, stop-free labels as of `2023-09-16` collected from ENS contract events and primary name records. 
 * [`38.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`423ec536c5ea0f3721f2ecd88949edb82d0cb9ed389c356f65d76c79cde43422` (SHA256)
<!-- /summary -->
