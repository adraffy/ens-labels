...
<!-- summary -->
`3,323,331` unique, stop-free labels as of `2025-03-09` collected from ENS contract events and primary name records.

* [`47.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`dd8b7e6b357c1016b31e6662412df247d80bc84e3c7b4fb40e59960046ebe5a4` (SHA256)
<!-- /summary -->
