...
<!-- summary -->
`3,283,893` unique, stop-free labels as of `2024-11-17` collected from ENS contract events and primary name records.

* [`47.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`bff83656dddf89627b384ca1d07a75d277073654e4550d833944f5333db217f9` (SHA256)
<!-- /summary -->
