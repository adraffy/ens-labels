...
<!-- summary -->
`2,911,294` unique, stop-free labels as of `2024-06-15` collected from ENS contract events and primary name records.

* [`42.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`f29b0757ce55b621336486d94a04040a9eeca820f2d67e91f83a8e93986ba458` (SHA256)
<!-- /summary -->
