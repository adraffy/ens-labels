...
<!-- summary -->
`3,359,732` unique, stop-free labels as of `2025-08-10` collected from ENS contract events and primary name records.

* [`48.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`7eb5b5e8d8fe4559bf228fb82d3fd50397d4068ed9312fc7a77f546a984effc4` (SHA256)
<!-- /summary -->
