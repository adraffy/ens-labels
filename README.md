...
<!-- summary -->
`2,906,857` unique, stop-free labels as of `2024-06-02` collected from ENS contract events and primary name records.

* [`42.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`4cbf06b6d0db2e2bd6efe8c39edaca1f0dbba94e82596d0f123d0ded34aa25d8` (SHA256)
<!-- /summary -->
