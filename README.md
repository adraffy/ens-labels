...
<!-- summary -->
`2,857,367` unique, stop-free labels as of `2024-04-14` collected from ENS contract events and primary name records.

* [`41.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`911432885bce797776c00e4f357d4d83a2d889af02470b3822eafaef5e837851` (SHA256)
<!-- /summary -->
