...
<!-- summary -->
`2,580,898` unique, stop-free labels as of `2023-06-04` collected from ENS contract events and primary name records. 
 * [`37.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`10681fa2d140254d7ccbbf48abcba64f1a10dd2337883eb729c341b8d62f0e98` (SHA256)
<!-- /summary -->
