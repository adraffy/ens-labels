...
<!-- summary -->
`3,340,162` unique, stop-free labels as of `2025-06-16` collected from ENS contract events and primary name records.

* [`48.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`b3cd6f3d049a4422b8808a311a007e92dfa53e4da9d9c6fb959215215f9c4c0c` (SHA256)
<!-- /summary -->
