...
<!-- summary -->
`2,936,228` unique, stop-free labels as of `2024-08-25` collected from ENS contract events and primary name records.

* [`42.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`c42f9ae9b8f07acd21adbd5f034835837ca51baf7b0f0e3e0d056a0991c88084` (SHA256)
<!-- /summary -->
