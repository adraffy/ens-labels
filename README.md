...
<!-- summary -->
`3,273,347` unique, stop-free labels as of `2024-09-29` collected from ENS contract events and primary name records.

* [`47.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`ba1a4eb3b5023a8ce23f827487f64ee1954fa7f7e02a88d345ad981561a7a051` (SHA256)
<!-- /summary -->
