...
<!-- summary -->
`3,309,758` unique, stop-free labels as of `2025-02-07` collected from ENS contract events and primary name records.

* [`47.6MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`63bee074a6b91cfc4c01f5a6679a8ef81a6bbab771cebc3786181165efed1ed5` (SHA256)
<!-- /summary -->
