...
<!-- summary -->
`3,416,919` unique, stop-free labels as of `2026-08-01` collected from ENS contract events and primary name records.

* [`49.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`0812024e11724b8eb13cae779143e90727fd7022dab5cd2d6b583bb822f93cf1` (SHA256)
<!-- /summary -->
