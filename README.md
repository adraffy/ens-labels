...
<!-- summary -->
`2,929,449` unique, stop-free labels as of `2024-07-29` collected from ENS contract events and primary name records.

* [`42.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`f7e279c5d6d4af19ae4333c027212214b6344fb9f4cafcef8b78aca5b20721ea` (SHA256)
<!-- /summary -->
