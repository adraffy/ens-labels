...
<!-- summary -->
`2,572,262` unique, stop-free labels as of `2023-05-22` collected from ENS contract events and primary name records. 
 * [`37.3MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`d6d1644906ed79cdbcbcb753537b69f114e085fe52f09a50ef460f8d9e9850b9` (SHA256)
<!-- /summary -->
