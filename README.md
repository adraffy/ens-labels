...
<!-- summary -->
`2,934,080` unique, stop-free labels as of `2024-08-18` collected from ENS contract events and primary name records.

* [`42.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`dd6ab59a63dec8063b243826223ef5035cea094a790c1d41ad270aee7b5c4c5b` (SHA256)
<!-- /summary -->
