...
<!-- summary -->
`3,417,306` unique, stop-free labels as of `2026-08-09` collected from ENS contract events and primary name records.

* [`49.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`c571b7b1e86be55a7462ba51ed9cacb2cddc869968c3e4676ef4ae2ecacfe2be` (SHA256)
<!-- /summary -->
