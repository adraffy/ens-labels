...
<!-- summary -->
`3,389,315` unique, stop-free labels as of `2025-12-13` collected from ENS contract events and primary name records.

* [`48.7MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`ee2d8f100c3dbaeaa6008c220c1e7b8eb8a2f8e6518db1b4124688543724a94a` (SHA256)
<!-- /summary -->
