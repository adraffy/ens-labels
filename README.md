...
<!-- summary -->
`2,944,008` unique, stop-free labels as of `2024-09-11` collected from ENS contract events and primary name records.

* [`42.5MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`5068668c31f126225e98cd74350923dd8b6df99f35cec21decffc39e9841e49a` (SHA256)
<!-- /summary -->
