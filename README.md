...
<!-- summary -->
`3,295,279` unique, stop-free labels as of `2025-01-09` collected from ENS contract events and primary name records.

* [`47.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`97ed47c8d4ebbb28f6934c82d622d233ec6ec503fe583df8f058a45ccb615e30` (SHA256)
<!-- /summary -->
