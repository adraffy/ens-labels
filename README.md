...
<!-- summary -->
`3,326,264` unique, stop-free labels as of `2025-03-29` collected from ENS contract events and primary name records.

* [`47.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`c2b493fe4e6939f3585485937a7e7bae89bd9615e3ed8cd0de4ceb0dfa600b88` (SHA256)
<!-- /summary -->
