...
<!-- summary -->
`3,277,049` unique, stop-free labels as of `2024-10-12` collected from ENS contract events and primary name records.

* [`47.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`81ef1483e8dff4ab4c0b331ef582bc1a3e6551a5390005d73146bf0e7c6126e8` (SHA256)
<!-- /summary -->
