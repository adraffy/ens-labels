...
<!-- summary -->
`3,343,993` unique, stop-free labels as of `2025-07-05` collected from ENS contract events and primary name records.

* [`48.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`2d51baeebb59160ff1dd0ba22c4db80df6f0ebb2a45d89767d14281c31ff8b13` (SHA256)
<!-- /summary -->
