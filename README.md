...
<!-- summary -->
`3,417,691` unique, stop-free labels as of `2026-08-16` collected from ENS contract events and primary name records.

* [`49.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`e84d631357ea34cd3a4e98258a5ae2d3bd50893241d668b91d63347e65f69caa` (SHA256)
<!-- /summary -->
