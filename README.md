...
<!-- summary -->
`2,595,438` unique, stop-free labels as of `2023-06-18` collected from ENS contract events and primary name records. 
 * [`37.6MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`a607544a7fa6de068f0f00afd7e50efc00109ee5c3ec46072607f71a8b0f13b6` (SHA256)
<!-- /summary -->
