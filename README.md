...
<!-- summary -->
`2,941,743` unique, stop-free labels as of `2024-09-04` collected from ENS contract events and primary name records.

* [`42.5MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`e67e239438915077b704c533149cb076d34a6ae3d4d7ea126d831a5abb6b2390` (SHA256)
<!-- /summary -->
