...
<!-- summary -->
`3,345,830` unique, stop-free labels as of `2025-07-14` collected from ENS contract events and primary name records.

* [`48.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`15b6084588d6d8e24cee7cf89401c72a597dd23cd01ae385df63a2d528bbfd35` (SHA256)
<!-- /summary -->
