...
<!-- summary -->
`3,395,353` unique, stop-free labels as of `2026-01-26` collected from ENS contract events and primary name records.

* [`48.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`162346fa92a1c87430265723f5f1bedcde47d8ebba1355d286f82c9253444c10` (SHA256)
<!-- /summary -->
