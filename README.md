...
<!-- summary -->
`3,335,473` unique, stop-free labels as of `2025-05-20` collected from ENS contract events and primary name records.

* [`47.9MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`d79bc4925aff4afdf17af9955da56ac39e7f1ad30b37cc3054f39d00fbaa1ddc` (SHA256)
<!-- /summary -->
