...
<!-- summary -->
`2,584,414` unique, stop-free labels as of `2023-06-10` collected from ENS contract events and primary name records. 
 * [`37.5MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`8420ff44e5e3ad2025411d3e4afdc22e6cfbdf0ae5c3dac153b6375d9d4e48af` (SHA256)
<!-- /summary -->
