...
<!-- summary -->
`3,410,709` unique, stop-free labels as of `2026-05-09` collected from ENS contract events and primary name records.

* [`49.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`4ab6a452a0e9c2ff56ae41d2d2c9e1bcc4501424a85a37dd955ab300cf2298c2` (SHA256)
<!-- /summary -->
