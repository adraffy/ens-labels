...
<!-- summary -->
`2,932,383` unique, stop-free labels as of `2024-08-12` collected from ENS contract events and primary name records.

* [`42.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`5212335a285d1c4fde29c76931384f1f528b4b3f839efded73a4e8c0f8c4f215` (SHA256)
<!-- /summary -->
