...
<!-- summary -->
`3,341,009` unique, stop-free labels as of `2025-06-21` collected from ENS contract events and primary name records.

* [`48.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`1125a1dea2e6c6d51aba48865203a9d4c01d76a879554a4c622083ebc5713964` (SHA256)
<!-- /summary -->
