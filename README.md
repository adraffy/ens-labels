...
<!-- summary -->
`3,416,222` unique, stop-free labels as of `2026-07-18` collected from ENS contract events and primary name records.

* [`49.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`7ff23a425f21f67edf84140bafe929a3c2805423d136f1b5519a621aa0868eb6` (SHA256)
<!-- /summary -->
