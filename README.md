...
<!-- summary -->
`3,408,279` unique, stop-free labels as of `2026-04-12` collected from ENS contract events and primary name records.

* [`49.0MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`37fd67544d4950d914ed5e8f47d502a243fbfa8a2de2cf8b7ebc1423a2893f61` (SHA256)
<!-- /summary -->
