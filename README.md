...
<!-- summary -->
`3,411,559` unique, stop-free labels as of `2026-05-17` collected from ENS contract events and primary name records.

* [`49.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`c4cc052344df464909b036a3354e398bb3114f34cb68656da7c8174fc4fddf41` (SHA256)
<!-- /summary -->
