...
<!-- summary -->
`3,382,864` unique, stop-free labels as of `2025-11-03` collected from ENS contract events and primary name records.

* [`48.6MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`6be357d776ed408ebb4369769c020c6731d1670106f86f76393e0cdadea35a59` (SHA256)
<!-- /summary -->
