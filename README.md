...
<!-- summary -->
`2,916,507` unique, stop-free labels as of `2024-06-24` collected from ENS contract events and primary name records.

* [`42.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`32ae283a8b3403f44e9817c4aa532cbb971156cea25ef197b38c7d9bc2dee437` (SHA256)
<!-- /summary -->
