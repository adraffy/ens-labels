...
<!-- summary -->
`3,396,407` unique, stop-free labels as of `2026-01-31` collected from ENS contract events and primary name records.

* [`48.8MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`15f30e4bdde2ca18713af101dbd9534f6a22a9e7cd05b93a53774b8a28a5df97` (SHA256)
<!-- /summary -->
