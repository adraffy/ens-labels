...
<!-- summary -->
`3,414,684` unique, stop-free labels as of `2026-06-28` collected from ENS contract events and primary name records.

* [`49.1MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`8210a138323caa1b4752669e0e4f953c441a07734af7d26a4008ff29a3347c78` (SHA256)
<!-- /summary -->
