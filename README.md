...
<!-- summary -->
`3,387,060` unique, stop-free labels as of `2025-11-24` collected from ENS contract events and primary name records.

* [`48.7MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`30c8a69e27095204c829e6da53b83c8fd1cbacb58550aff4d49def9019e0f658` (SHA256)
<!-- /summary -->
