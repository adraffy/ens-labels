...
<!-- summary -->
`3,286,342` unique, stop-free labels as of `2024-12-01` collected from ENS contract events and primary name records.

* [`47.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`070ce40902ed3d303812e2065546acd82cd3f00de34988e5f17d0b5441554800` (SHA256)
<!-- /summary -->
