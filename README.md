...
<!-- summary -->
`2,776,286` unique, stop-free labels as of `2024-01-13` collected from ENS contract events and primary name records. 
 * [`40.2MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`ae4ca996cd7b957cbe433b984dbe3b129e5064cd8e6bc7b4926d1fc552f176bf` (SHA256)
<!-- /summary -->
