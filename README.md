...
<!-- summary -->
`2,545,429` unique, stop-free labels as of `2023-04-04` collected from ENS contract events and primary name records. 
 * [`36.9MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`5f5e9964a53c3e3ca4495a32bb7ad954520dc98ddb017bca9e8de5520153a075` (SHA256)
<!-- /summary -->
