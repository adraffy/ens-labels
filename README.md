...
<!-- summary -->
`2,648,909` unique, stop-free labels as of `2023-08-12` collected from ENS contract events and primary name records. 
 * [`38.4MB`](https://github.com/adraffy/ens-labels/raw/master/labels.json) — [labels.json](./labels.json)<br>`09113593a19bd36d67aa393d5c47e322eee38c2ae041fb507548adf99fc7f128` (SHA256)
<!-- /summary -->
